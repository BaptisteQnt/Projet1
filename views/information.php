<div class="d-flex bd-highlight">
    <div class="p-2 flex-fill bd-highlight ms-4" >
        <div class="container-fluid mt-5">
            <h3 class="text-danger fs-3 fw-bold mb-3">Présentation du projet</h3>
            <p class="mt-5 text-start text-wrap fs-5 ms-4">1Experience est un projet se basant sur le système de stage en immersion au sein d'une entreprise. 
                Car d'après notre expérience, les emplois sont plus facile à obtenir après un stage en entreprise de plusieurs semaines. 
                Ainsi, le recruteur est rassuré et peut pourvoir un poste avec enthousiasme.</p>
        </div>
        <div class="container-fluid mt-5">
